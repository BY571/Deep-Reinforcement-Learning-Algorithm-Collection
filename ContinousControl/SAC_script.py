...
def SAC(n_episodes=200, max_t=500, print_every=10):
    ...
    for i_episode in range(1, n_episodes+1):
        ...
        writer.add_scalar("max_reward", score, i_episode)
...
parser.add_argument("-repm", "--replay_memory", type=float, default=1e6, help="Size of the Replay memory, default is 1e6")
...
if saved_model != None:
    ...
    scores, average_100 = SAC(n_episodes=n_episodes, max_t=2300, print_every=10)
t1 = time.time()
env.close()
